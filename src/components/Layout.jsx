                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-16">
                        <div className="flex-shrink-0 flex items-center gap-2">
                            <div className="w-8 h-8 bg-gradient-to-br from-primary to-blue-600 rounded-lg flex items-center justify-center text-white font-bold text-xl shadow-lg">
                                Y
                            </div>
                            ...
                            {currentUser ? (
                                <div className="relative ml-4">
                                    <button
                                        ...
                                        className="flex items-center gap-2 px-4 py-2 rounded-lg bg-white/80 border border-gray-200 hover:bg-white hover:shadow-md transition-all"
                                    >
